...
$u_1\in[d+b\theta+\Vert\overrightarrow{PQ}\Vert+a(\pi+\theta)+c\sin(\phi), b\theta+\Vert\overrightarrow{PQ}\Vert+a(\pi+\theta)+H-e\sin(\phi)]$, $u_2\in[d+b\theta, d+b\theta+\Vert\overrightarrow{PQ}\Vert]$,
$$
...
$$
r_1 = d\tan(\phi) + e\sec(\phi)-(H-u+d+b\theta+\Vert\overrightarrow{PQ}\Vert+a(\pi+\theta))\tan(\phi)
$$
