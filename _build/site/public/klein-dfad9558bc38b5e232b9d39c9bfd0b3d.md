...
$$
\mathbf{x}_1 = \gamma_1 - r_1\dot{r_1}\mathbf{T_1} + r_1\sqrt{1-\dot{r_1}^2}(\mathbf{N_1}\cos(v)+\mathbf{B_1}\sin(v)) ,
$$

$$
\mathbf{x}_2 = \gamma_2 - r_2\dot{r_2}\mathbf{T_2} + r_2\sqrt{1-\dot{r_2}^2}(\mathbf{N_2}\cos(v)+\mathbf{B_2}\sin(v))
$$

$$
\gamma_1 = \left(0,0,H-u+d+b\theta+\Vert\overrightarrow{PQ}\Vert+a(\pi+\theta))\right)
$$

$$
r_1 = e\sec(\phi)-(H-u+b\theta+\Vert\overrightarrow{PQ}\Vert+a(\pi+\theta))\tan(\phi)
$$
...
$$
\gamma_2 = \frac{u-d-b\theta}{\Vert\overrightarrow{PQ}\Vert}P + \frac{1-u+d+b\theta}{\Vert\overrightarrow{PQ}\Vert}Q
$$
