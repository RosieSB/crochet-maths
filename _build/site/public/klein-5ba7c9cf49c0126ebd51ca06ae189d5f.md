...
v = np.linspace(0,2*np.pi,100)
x = ((e+p)/2-((e-p)/2))*np.sin(v)
y = ((e+p)/2-((e-p)/2))*np.cos(v)
z = d
ax.plot(x,y,z,color='red',linewidth=.5)
...
1. Make a foundation chain of {eval}`base7[0,1]` stitches, and join into a ring. 
