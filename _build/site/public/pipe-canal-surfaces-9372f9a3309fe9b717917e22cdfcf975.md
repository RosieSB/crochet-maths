...
ax.text(0, -.4*a ,h/2 ,r'$\gamma_1$', color='tab:blue', fontsize=16)
...
ax.text(0, 2.4*a ,1.4*h ,r'$\gamma_2$', color='tab:orange', fontsize=16)
...
ax.text(0, (P[1]+Q[1])/2 ,(P[2]+Q[2])/2 ,r'$\gamma_3$', color='tab:green', fontsize=16)
