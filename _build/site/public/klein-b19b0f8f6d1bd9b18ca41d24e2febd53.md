...
- $r_2(u)=e\sec\phi-(u-d)\tan\phi$, $\dot r_2(u)=-\tan\phi$, for $u\in[d+e\sin\phi,d+h-c\sin\phi]$.
- $r_3(u)=p+c-\sqrt{c^2-(u0d-h)^2}$, $\dot r_3(u)=\frac{u-d-h}{\sqrt{c^2-(u-d-h)^2}}$ for $u\in[d+h-c\sin\phi,h]$.
