...
and
$$
\ddot{r}(u)=\left\{\begin{array}{lr} -\frac{\sqrt{e^2-(u-d)^2}+\frac{(u-d)^2}{\sqrt{e^2-(u-d)^2}}}{\left(e^2-(u-d)^2\right)^2} & \text{ for } d\leq u\leq d+e\sin\phi \\
0 & \text{ for } d+e\sin\phi\leq u\leq d+h-c\sin\phi \\
\frac{\sqrt{c^2-(u-d-h)^2}-\frac{(u-d-h)^2}{\sqrt{c^2-(u-d-h)^2}}}{\left(c^2-(u-d-h)^2\right)^2} & \text{ for } d+h-c\sin\phi\leq u\leq d+h,
\end{array}\right.
$$
Moreover, 
:::{math}
