...
$$
A_1 = (e\sec(\phi)-(H+b\theta+\Vert\overrightarrow{PQ}\Vert+a(\pi+\theta))\tan(\phi))\sqrt{1-\tan^2\phi}
$$
...
$$
B_3+B_4u = Q_2+ (d+b\theta)\hat{\overrightarrow{PQ}}_2- u\hat{\overrightarrow{PQ}}_2-p\hat{\overrightarrow{PQ}}_1
$$
:::{code-cell} python
:tags: remove-input
