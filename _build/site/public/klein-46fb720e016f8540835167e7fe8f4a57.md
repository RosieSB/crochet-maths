...
- Straight segment 2: 
$$
\gamma_3(t)=\frac{t}{\right\Vert\overrightarrow{PQ}\left\Vert}Q + \left(1-\frac{t}{\left\Vert\overrightarrow{PQ}\right\Vert}\right)P,\hspace{1em} t\in[0,{\Vert Q-P\Vert}]
$$
