...
\end{array}\right) \\
&= \left(\begin{array}{c} 
\cos\left(\frac{u}{\sqrt{2}}\right)\left(1-\frac{\sqrt{u^6-4}}{u^5}\cos(v)\right)  -\frac{\sqrt2}{u^5}\sin\left(\frac{u}{\sqrt{2}}\right) +\frac{1}{\sqrt{2}}\sin\left(\frac{u}{\sqrt{2}}\right)\sin(v) \\
