...
for k in range(i,j+1):
    ...
    u1 = body[k,2]
    print('\nRow ', row, ':', st_count, '-(?) st omitting (?) st from previous row. ')    
    print('u =',u1)
    ...
    print((C1-C3)/C2+B3/B2,'+',-B1/B2,'cos(v1) = ',C4/C2-B4/B2,'cos(v2)')

    print(((C1-C3)/C2+B3/B2)**2,'+',2*(-B1/B2)*((C1-C3)/C2+B3/B2),'cos(v1) +',(B1/B2)**2,'cos²(v1) = ',(C4/C2-B4/B2)**2,'cos²(v2)')
