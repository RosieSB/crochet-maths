...
rc = rc.append([rc[5]+1,max(row)])
:::
**Rows {eval}`rc[6]`–{eval}`rc[7]`:**
Work the following row counts in the round, spacing increases evenly throughout each round.
:::{code-cell} python
:tags: remove-input
display(table)
:::
