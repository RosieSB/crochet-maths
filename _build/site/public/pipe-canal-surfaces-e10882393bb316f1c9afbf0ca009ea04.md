...
**References:** Mostly following [Hartman *Geometry and Algorithms for Computer Aided Design*](https://www2.mathematik.tu-darmstadt.de/~ehartmann/cdgen0104.pdf), pp. 117, although there are problems with their mathematical derivations.. [Hilbert & Cohn-Vossen *Geometry and the Imagination* (1999)](https://en.wikipedia.org/wiki/Geometry_and_the_Imagination) also mentions them - see page 231.
...
which is precisely the parametrisation of [](CT). 
