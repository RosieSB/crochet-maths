...
print("This completes the upper hald of the torus. For the lower half, turn work upside down and repeat rows 1 to ", N-1,". Fill with stuffing and stitch around, weaving in ends as needed.")
```
