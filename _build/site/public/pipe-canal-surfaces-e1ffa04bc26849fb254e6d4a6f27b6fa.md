...
&= (R,0,0) + \sum_{m=0}^\infty\frac{(-1)^m(\kappa\cdot\delta u)^{(2m+1)}}{(2m+1)!}R\mathbf{T}(u) + \sum_{m=0}^\infty\frac{(-1)^m(\kappa\cdot\delta u)^{(2m+2)}}{(2m+2)!}R\mathbf{N}(u) \\
&= (R,0,0) + R\sin(\kappa\cdot\delta u)\mathbf{T}(u) - \cos(\kappa\cdot\delta u)R\mathbf{N}(u) + R\mathbf{N}(u) \\
&= (R,0,0) + R\sin(\kappa\cdot\delta u)(0,1,0) - \cos(\kappa\cdot\delta u)R(-1,0,0) + R(-1,0,0) \\
...
&= (R\cos(\kappa\cdot\delta u),R\sin(\kappa\cdot\delta u),0) + r\left(\big(-\cos(\kappa\cdot\delta u),-\sin(\kappa\cdot\delta u),0\big)\cos(v)+(0,0,1)\sin(v) \right) \\
\end{align*}