...
At a site of increase or decrease, the order of the vertex goes up or or down according to the number of stitches gained or lost, but the interior angles and voronoidal area contributed by each stitch do not change (much). This means that both the angle sum and combined voronoidal area will scale by a factor of $\frac{d(v)}{4}=1+\frac\text{{#increases}-\text{#decreases}}{4}$. So, the curvature will be
$$
