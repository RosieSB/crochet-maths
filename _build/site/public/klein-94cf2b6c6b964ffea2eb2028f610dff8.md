...
$$
\begin{aligned}
\mathbf{x}_u  &= \left(1-r\ddot{r}-\dot{r}^2\right)\mathbf{T} + \frac{\dot{r}\left(1-\dot{r}^2-r\ddot{r}\right)}{\sqrt{1-\dot{r}^2}}\cos(v)\mathbf{N} \\
...
$$
\begin{aligned}
E = \mathbf{x}_u^2  &= \left(1-r\ddot{r}-\dot{r}^2\right)^2 + \frac{\dot{r}^2(1-\dot{r}^2-r\ddot{r})^2}{1-\dot{r}^2}
\end{aligned}
$$
