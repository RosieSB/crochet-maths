...
$$
\mathbf{x} = \left(\begin{array}{c}
\left((p+c)\sqrt{\frac{c^2-2(u-d-h)^2}{c^2-(u-d-h)^2}}-\sqrt{c^2-2(u-d-h)^2}\right)\sin(v)\\[1em]
\left((p+c)\sqrt{\frac{c^2-2(u-d-h)^2}{c^2-(u-d-h)^2}}-\sqrt{c^2-2(u-d-h)^2}\right)\cos(v)\\[1em]
