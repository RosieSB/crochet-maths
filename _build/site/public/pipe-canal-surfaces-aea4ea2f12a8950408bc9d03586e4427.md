...
x = gamma[0] - r*absrdot*T[0] + r*np.sqrt(1-(absdotr)**2)*(N[0]*np.cos(v)+B[0]*np.sin(v)) 
y = gamma[1] - r*absrdot*T[1] + r*np.sqrt(1-(absdotr)**2)*(N[1]*np.cos(v)+B[1]*np.sin(v)) 
z = gamma[2] - r*absrdot*T[2] + r*np.sqrt(1-(absdotr)**2)*(N[2]*np.cos(v)+B[2]*np.sin(v)) 
