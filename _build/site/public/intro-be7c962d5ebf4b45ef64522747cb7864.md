...
Returning to the crochet of [](#fig:flat-crochet) and [](#fig:inc-dec-crochet), we have the followinggraphs for vertices $u$, $v$ and $w$:
...
Vertex $u$ and adjacent vertices
:::
::::
::::{grid-item}
...
Vertex $v$ and adjacent vertices
:::
::::
::::{grid-item}
...
Vertex $w$ and adjacent vertices
:::
::::
:::::