...
xyticks = [-b,-a,a,b,P[1],Q[1]]
zticks = [0,d,z2,z3,z4,z5,z6,z7]
ax1.set_xticks(xyticks)
ax1.set_yticks(xyticks)
ax1.set_zticks(zticks)

ax2.set_aspect('equal')
ax2.set_xticks([a,b,P[1],Q[1]])
ax2.set_yticks([t[0],t[1],t[2],t[3],t[4],P[2],Q[2]])
ax2.grid(True)
