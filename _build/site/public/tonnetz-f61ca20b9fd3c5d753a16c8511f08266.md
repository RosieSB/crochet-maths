...
Below is some code that will do this, along with its output pattern. Parameter values[^prams] $R = 8
r = 3,\;
w = 0.6,\;
h = 0.6$ have been chosen fairly arbitrarily.
