...
fig, axs = plt.subplots(4, 1, subplot_kw={'projection': '3d'})
fig.set_figheight(32)
fig.set_figwidth(8)

axs[0].view_init(elev=30, azim=45, roll=0)
axs[1].view_init(elev=30, azim=225, roll=0)
axs[2].view_init(elev=-30, azim=45, roll=0)
axs[3].view_init(elev=-30, azim=225, roll=0)
