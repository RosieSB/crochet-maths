...
$$
\mathbf{x} = \left(\begin{array}{c}
\left(\frac{(p+c)\sqrt{c^2-2(u-d-h)^2}}{\sqrt{c^2-(u-d-h)^2}}-\sqrt{c^2-2(u-d-h)^2}\right)\sin(v)\\[1em]
\left(\frac{(p+c)\sqrt{c^2-2(u-d-h)^2}}{\sqrt{c^2-(u-d-h)^2}}-\sqrt{c^2-2(u-d-h)^2}\right)\cos(v)\\[1em]
