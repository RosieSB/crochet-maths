...
u = np.concatenate([u,u7],axis=1)
z = np.concatenate([z,d+d*np.sin(u7)],axis=1)
E = np.concatenate([E,E7],axis=1)
G = np.concatenate([G,G7],axis=1)
du = np.concatenate([du,du7],axis=1)
