...
def f(d,a,b,theta):
    ...
    ax.text(0, -.35*a ,h/2 ,'𝛄₁', color='tab:blue', fontsize=16)
    ...
    ax.text(0, 2.05*a ,1.1*h ,'𝛄₂', color='tab:orange', fontsize=16)
    ...
    ax.text(0, (P[1]+Q[1])/2-.1*a ,(P[2]+Q[2])/2-.3*a ,'𝛄₃', color='tab:green', fontsize=16)
    ...
    ax.text(0, b+b*np.cos(np.pi-theta/2)+.1*a, b*np.sin(np.pi-theta/2)-.1*a, '𝛄₄', color='tab:red', fontsize=16)
    ...
    ax.text(0, -.35*a, d/2, '𝛄₅', color='tab:purple', fontsize=16)
