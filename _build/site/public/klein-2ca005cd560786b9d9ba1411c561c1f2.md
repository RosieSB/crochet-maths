...
d \\ 
d+b\theta \\
d+b\theta+\left\Vert\overrightarrow{PQ}\right\Vert \\
d+b\theta+\left\Vert\overrightarrow{PQ}\right\Vert+a(\pi+\theta)\\
d+b\theta+\left\Vert\overrightarrow{PQ}\right\Vert+a(\pi+\theta)+c\sin(\phi)\\
b\theta+\left\Vert\overrightarrow{PQ}\right\Vert+a(\pi+\theta)+H-e\sin(\phi) \\
b\theta+\left\Vert\overrightarrow{PQ}\right\Vert+a(\pi+\theta)+H \\
d+b\theta+\left\Vert\overrightarrow{PQ}\right\Vert+a(\pi+\theta)+H
\end{array}\right)
$$
