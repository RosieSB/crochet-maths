...
While it is true that a canal surface with directrix the $z$ axis is a surface of revolution, it is not the same as the surface obtained by revolving the radius function around the $z$ axis. This is a consequence of the envelope conditon [](#eq:envelope-cond) of [Chapter **%s**](#canal).
