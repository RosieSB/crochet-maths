...
I,  trick will be choosing the right directrix and radius function, for optimum crochetability. 
...
fig, axs = plt.subplots(1, 2, subplot_kw={'projection': '3d'}, figsize=(12,6), layout='constrained')
