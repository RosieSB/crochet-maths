...
fig, axs = plt.subplots(1,2,figsize=(16,9), gridspec_kw={'width_ratios': [1, 2]})
fig.suptitle('Klein bottle as canal surface')

ax[0].set_title('Directrix')
...
z = d-d*np.sin(u)
ax[1].plot_surface(x, y, z, color = 'blue', edgecolor = 'black', linewidth = .1, alpha = .25)
...
ax[1].set_title('Klein bottle surface')

# Axis labels
ax[0].set_xlabel('y')
ax[0].set_ylabel('z')
#ax[0].set_xlim(-.1*2*a,1.1*2*a)
#ax[0].set_ylim(0,1.1*(h+d+a))

ax[1].set_xlabel('x')
ax[1].set_ylabel('y')
ax[1].set_zlabel('z')
#ax[1].set_xlim(-1.1*2*a,1.1*2*a)
#ax[1].set_ylim(-1.1*2*a,1.1*2*a)
#ax[1].set_zlim(0,1.1*(h+d+a))

ax[0].set_aspect('equal')
ax[1].set_aspect('equal')

ax[1].view_init(elev=0, azim=0, roll=0)
