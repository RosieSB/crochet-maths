...
- Straight segment 1: $\gamma_1(t)=(0,0,-t)$, $t\in[d,h]$ 

- Circlular arc 1: $\gamma_2(t)=\left(0,a+a\cos\left(\pi-\frac{t}{a}\right), h+a\sin\left(\pi-\frac{t}{a}\right)\right)$, $t\in[0,a(\pi+\theta)]$

- Straight segment 2: $\gamma_3(t)=\frac{t}{\Vert Q-P\Vert}Q + \left(1-\frac{t}{\Vert Q-P\Vert}\right)P$, $t\in[0,{\Vert Q-P\Vert}]$

- Circular arc 2: $\gamma_4(t)=\left(0, b+b\cos\left(\pi-theta+\frac{t}{b}\right), b\sin\left(\pi-theta+\frac{t}{b}\right)\right)$, $t\in[0,b\theta]$

- Straight segment 3: $\gamma_5$
...
ax.text(0, -.3*a, d/2, r'$\gamma_4$', color='tab:purple', fontsize=16)
