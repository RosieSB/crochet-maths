...
**Upper half:** Begin with a foundation chain joined into a loop. Work the stitch counts below in each row. Increases are made using 2 st in st of previous row, evenly distributed for a symmetrical look. 
