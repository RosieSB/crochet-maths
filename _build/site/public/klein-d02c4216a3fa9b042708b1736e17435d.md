...
&= \left(\begin{array}{c}
p\sin(v_2)\\
(\gamma_2(u_2))_2+p\hat{\overrightarrow{PQ}}_2 \\
(\gamma_2(u_2))_3-p\hat{\overrightarrow{PQ}}_1
...
r_1(u_1)\sqrt{1-\tan^2\phi}\cos(v_1) &=& (\gamma_2(u_2))_2+p\hat{\overrightarrow{PQ}}_2\cos(v_2) \\
(\gamma_1(u_1))_3+r_1\tan\phi &=& (\gamma_2(u_2))_3-p\hat{\overrightarrow{PQ}}_1\cos(v_2)
\end{array}\right.
$$
...
$$
\left\{\begin{array}{rclr}
r_1(u_1)\sqrt{1-\tan^2\phi} &=& (\gamma_2(u_2))_2+p\hat{\overrightarrow{PQ}}_2 &\text{ (A)}\\
(\gamma_1(u_1))_3+r_1\tan\phi &=& (\gamma_2(u_2))_3-p\hat{\overrightarrow{PQ}}_1 &\text{ (B)}
\end{array}\right.
$$
...
A1 = (e/np.cos(phi)-(H+b*theta+magPQ+a*(np.pi+theta))*tanphi)*np.sqrt(1-(np.tan(phi))**2)
A2 = (np.tan(phi))**2
