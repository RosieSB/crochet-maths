...
Parametrisation:
- $r_1(u)=\sqrt{e^2-(u-d)^2}$, $\dot r_1(u)=-\frac{u}{\sqrt{e^2-(u-d)^2}}$, for $u\in[d,d+e\sin\phi]$.
- $r_2(u)=e\sec\phi-u\tan\phi$, $\dot r_2(u)=-\tan\phi$, for $u\in[d+e\sin\phi,d+h-c\sin\phi]$.
- $r_3(u)=p+c-\sqrt{c^2-(u-h)^2}$, $\dot r_3(u)=\frac{u-h}{\sqrt{c^2-(u-h)^2}}$ for $u\in[d+h-c\sin\phi,h]$.
