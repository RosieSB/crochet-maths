...
Attempts 1 (left) and 2 (right) viewed side by side and from different angles, for comparison.
:::

As can be seen in [](fig:7-colour-2), the pattern for attempt 2 (right resulted in a less distorted torus than that of attempt 1 (left), and with more circular cross-sections. However, it is very small. 
