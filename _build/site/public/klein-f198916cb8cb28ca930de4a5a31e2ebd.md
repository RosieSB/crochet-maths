...
We can also calculate the $u$ step required --- probably this will not be constant. 

Write $0=u_0,u_1,u_2,\ldots$ for the $u$ values associated with rows $n=0,1,2\ldots$. Then
$$
h \approx \sqrt{E|_{u=u_n}}\cdot (u_n-u_n-1), \hspace{1em} n=1,2,\ldots.
$$
We can solve this numerically/iteratively for a given set of parameter values.
