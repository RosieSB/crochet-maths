...
- Circlular arc 1: $\gamma_2(t)=\left(a+a\cos\left(\pi-\frac{t}{a}\right), h+a*sin\left(\pi-\frac{t}{a}\right)\right)$, $t\in[0,a(\pi+\theta)]$

- Straight segment 2: $\gamma_3(t)=\frac{t}{\Vert Q-P\Vert}Q + \left(1-\frac{t}{\Vert Q-P\Vert}\right)P$,
