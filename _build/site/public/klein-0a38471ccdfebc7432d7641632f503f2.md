...
so {eval}`float(np.round(tanphi*sqrt1mt2/(-PQhat[1])+(1-tanphi**2)/(-PQhat[2]),dp))` $u_1 = $ {eval}`float(np.round((gamma2const[1]+p*PQhat[2]-r1const*sqrt1mt2)/(-PQhat[1])+(gamma13const+r1const*tanphi-gamma2const[2]+p*PQhat[1])/(-PQhat[2]),dp))`

and so $u_1 = $ {eval}`float(np.round(((gamma2const[1]+p*PQhat[2]-r1const*sqrt1mt2)/(-PQhat[1])+(gamma13const+r1const*tanphi-gamma2const[2]+p*PQhat[1])/(-PQhat[2]))/(tanphi*sqrt1mt2/(-PQhat[1])+(1-tanphi**2)/(-PQhat[2])),dp))`
