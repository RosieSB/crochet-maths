...
To illustrate this, suppose we have unit speed directrix $\gamma(u)=(0,0,u)$ and Frenet-Serret apparatus $\mathbf{T}=(0,0,1)$, $\mathbf{N}=(0,1,0)$, $\mathbf{B}=(1,0,0)$. The canal parametrisation simplifies to
$$
\begin{aligned}
...
On the otherhand, rotating $z=r(z)$ around the $z$ axis gives rise to a surface with parametrisation
$$
\mathbf{x}(u,v) = \left(r\sin(v),r\cos(v),u\right).
$$
Importantly, this is *not* an envelope of spheres, and does not satisfy the usual envelope condition for a canal surface. 
...
ax1.plot_surface(x, y, z, color = 'blue', edgecolor = 'black', linewidth = .1, alpha = .25)
ax1.set_title('Klein bottle as canal surface')
...
ax2.set_title('Klein bottle as surface of revolution + pipe surface')
