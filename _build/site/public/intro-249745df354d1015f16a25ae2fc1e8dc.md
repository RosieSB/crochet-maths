...
Suppose we have crocheted $n$ dc stitches into a magic ring. Then,
...
$$
\frac{h+r}{a} = \frac{r}{b}, \text{ so } r = \frac{bh}{a-b},
$$

$$
b=2r\sin\theta = \frac{2bh}{a-b}\sin\left(\frac{2\pi}{n}\right),
$$

$$
a=2(h+r)\sin\theta = \frac{2ah}{a-b}\sin\left(\frac{2\pi}{n}\right),
$$
...
$$
n= \frac{2\pi}{\arcsin\left(\frac{a-b}{2h}\right)}.
$$
