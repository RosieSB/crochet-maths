...
:::
**Rows {eval}`max(row0)+1`–{eval}`max(row0)+2*int(np.round(theta/turning_angle_b))+1`:**
...
**Rows {eval}`max(row0)+2*int(np.round(theta/turning_angle_b))+2`–{eval}`max(row0)+2*int(np.round(theta/turning_angle_b))+int(np.round(magPQ/h))+2`:**
{eval}`dual_st_count_b[0]` dc in each st around, {eval}`int(np.round(magPQ/h))` times.

**Rows {eval}`max(row0)+2*int(np.round(theta/turning_angle_b))+int(np.round(magPQ/h))+3`–{eval}`max(row0)+2*int(np.round(theta/turning_angle_b))+int(np.round(magPQ/h))+int(np.round((np.pi+theta)/turning_angle_a))+3`** 
Repeat the following rows {eval}`int(np.round((np.pi+theta)/turning_angle_a))` times:
