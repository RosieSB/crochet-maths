...
\end{array}\right) \\
&= \left(\begin{array}{c} 
\cos\left(\frac{u}{\sqrt{2}}\right)  -\frac{\sqrt2}{u^5}\sin\left(\frac{u}{\sqrt{2}}\right) \\
\sin\left(\frac{u}{\sqrt{2}}\right) + \frac{\sqrt2}{u^5}\cos\left(\frac{u}{\sqrt{2}}\right) \\
\frac{u}{\sqrt{2}} + \frac{\sqrt2}{u^5} + \frac{\sqrt{u^6-4}}{u^5}\frac{1}{\sqrt{2}}\sin(v)
\end{array}\right)\\
&\hspace{1.5em}+ \left(\begin{array}{c} 
-\frac{\sqrt{u^6-4}}{u^5}\cos\left(\frac{u}{\sqrt{2}}\right)\cos(v)+\frac{1}{\sqrt{2}}\sin\left(\frac{u}{\sqrt{2}}\right)\sin(v) \\
-\frac{\sqrt{u^6-4}}{u^5}\sin\left(\frac{u}{\sqrt{2}}\right)\cos(v)-\frac{1}{\sqrt{2}}\cos\left(\frac{u}{\sqrt{2}}\right)\sin(v) \\
\end{array}\right)
\end{align*}
