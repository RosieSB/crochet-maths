...
$$
\text{Stitch height} \approx \sqrt{E|_{u=u_n}}\cdot (u_n-u_{n-1}), \hspace{1em} n=1,2,\ldots.
$$
We can solve this numerically/iteratively for a given set of parameter values and crochet gauge.
