...
Let $v$ be a vertex in a triangular mesh, and let $T(v)$ denote the set of triangles incident at $v$. 
...
Returning to the mesh with vertex $v$, consider the voronoidal regions associated with each triangle incident at $v$. Let $A_v$ denote the combined area of these regions. Label the triangles incident at $v$ clockwise as $T_1,\ldots,T_n$ and let $\theta_1,\ldots,\theta_n$ denote the corresponding angles at $v$.
