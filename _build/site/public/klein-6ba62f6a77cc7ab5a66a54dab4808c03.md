...
for k in range(i,j+1):
    ...
    si_data[k-i,:] = [row, st_count, st_omit, u1]

si_table = tabulate(si_data, headers=['Row','Stitch count + missing stitches','Stitches to omit from previous row', 'u'])
display(si_table)
