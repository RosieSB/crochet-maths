...
:label: handle-table
:tags: remove-input
table = tabulate(base0,headers=['Row','Stitch count','u','z','E','G','du','dz','ds=√Edu','s=row×(stitch height)','Circumference=2π√G'],tablefmt='html')
display(table)
:::
...
table = tabulate(data,headers=['Row','Stitch count','u','z','E','G','du','dz','ds=√Edu','s=row×(stitch height)','Circumference=2π√G'],tablefmt='html')
