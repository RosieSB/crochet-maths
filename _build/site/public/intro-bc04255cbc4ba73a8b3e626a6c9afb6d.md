...
Assuming the initial round is functionally a flat disc, which it appears to be, we can probably safely $\theta=\frac{\pi}{6}$ so that $K(v_0)=0$. 

What about subsequent rows?