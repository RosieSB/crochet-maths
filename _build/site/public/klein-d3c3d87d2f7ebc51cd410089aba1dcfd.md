...
### Main body - $\ddot r$ formulae need checking!
...
gamma = np.concatenate([gamma4[1:],gamma5[1:],gamma6[1:]],axis=1)

print(gamma)

r = np.concatenate([r4[1:],r5[1:],r6[1:]])
