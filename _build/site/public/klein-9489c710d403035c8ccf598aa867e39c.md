...
We will see that these two parametrisations agree at $u=d$, since $\dot{r}=0$ here. See [](#canal_v_SoR) for more detailed discussion of these two methods for generating parametrised surfaces from curves.
