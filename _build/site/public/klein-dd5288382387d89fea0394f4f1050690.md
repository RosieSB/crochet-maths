...
for k in range(i,j+1):
    ...
    #( u1*np.tan(phi)*np.sqrt(1-(np.tan(phi))**2)+(d*np.tan(phi) + e/np.cos(phi)-(H-c*np.sin(phi)+t[5])*np.tan(phi))*np.sqrt(1-(np.tan(phi))**2) )*np.sin(v1) = p*np.sin(v2)) 
    A1 = u1*np.tan(phi)*np.sqrt(1-(np.tan(phi))**2)+(d*np.tan(phi) + e/np.cos(phi)-(H-c*np.sin(phi)+t[5])*np.tan(phi))*np.sqrt(1-(np.tan(phi))**2)
    A2 = p
