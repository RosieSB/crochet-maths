...
More generally
\begin{gather*}
\mathbf{T}^{(2m)}(u) = (-1)^m\kappa^{2m}\mathbf{T}(u) = (-1)^m\kappa^{2m}(0,1,0), \;\; \mathbf{T}^{(2m+1)}(u) = (-1)^m\kappa^{2m+1}\mathbf{N}(u) = (-1)^m\kappa^{2m+1}(-1,0,0), \\
\mathbf{N}^{(2m)}(u) = (-1)^m\kappa^{2m}\mathbf{N}(u) = (-1)^m\kappa^{2m}(-1,0,0), \;\; \mathbf{N}^{(2m+1)}(u) = (-1)^{m+1}\kappa^{2m+1}\mathbf{T}(u) = (-1)^{m+1}\kappa^{2m+1}(0,1,0).
\end{gather*}
