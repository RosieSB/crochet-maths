...
nh \approx \sqrt{E}u
$$
(remember $u$ is arc length for the directrix, and begins at $0$).

To work out the total number of rows needed we need only evaluate at $u=d+h$ and divide by stitch height.
