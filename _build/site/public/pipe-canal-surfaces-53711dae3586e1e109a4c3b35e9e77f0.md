...
&= (R,0,0) + \sum_{m=0}^\infty\frac{(-1)^m(\kappa\cdot\delta u)^{(2m+1)}}{(2m+1)!}R\mathbf{T}(u) + \sum_{m=0}^\infty\frac{(-1)^m(\kappa\cdot\delta u)^{(2m+2)}}{(2m+2)!}\kappa^{2m+2}R\mathbf{N}(u) \\
\end{align*}
...
&= \gamma(u)+\delta u\dot\gamma(u)+ + r\left(\big(-\cos(\kappa\cdot\delta u),-\sin(\kappa\cdot\delta u),0\big)\cos(v)+(0,0,1)\sin(v) \right) \\
\end{align*}