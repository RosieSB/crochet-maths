...
\frac{u-t[2]}{\Vert\overrightarrow{PQ}\Vert}P + \left(1-\frac{u-t[2]}{\Vert\overrightarrow{PQ}\Vert}\right)Q & d+b\theta\leq u\leq d+b\theta + \Vert\overrightarrow{PQ}\Vert\\
& d+b\theta + \Vert\overrightarrow{PQ}\Vert \leq u\leq d+b\theta + \Vert\overrightarrow{PQ}\Vert+ a(\pi+\theta) \\
& d+b\theta + \Vert\overrightarrow{PQ}\Vert+ a(\pi+\theta) \leq u\leq d+b\theta + \Vert\overrightarrow{PQ}\Vert+ a(\pi+\theta)+c\sin\phi \\
& d+b\theta + \Vert\overrightarrow{PQ}\Vert+ a(\pi+\theta)+c\sin\phi  \leq u\leq b\theta+\Vert\overrightarrow{PQ}\Vert+a(\pi+\theta)+H-e\sin\phi\\
& d+b\theta + \Vert\overrightarrow{PQ}\Vert+ a(\pi+\theta)+H-e\sin\phi  \leq u\leq b\theta+\Vert\overrightarrow{PQ}\Vert+a(\pi+\theta)+H\\
& d+b\theta + \Vert\overrightarrow{PQ}\Vert+H \leq u\leq b\theta+\Vert\overrightarrow{PQ}\Vert+a(\pi+\theta)+H+d
\end{array}\right.
$$
