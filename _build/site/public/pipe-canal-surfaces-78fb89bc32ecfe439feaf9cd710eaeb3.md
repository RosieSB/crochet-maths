...
&= \left(\begin{array}{c} 
(1-r\cos(v))\cos\left(\frac{u}{\sqrt{2}}\right) + \frac{r}{\sqrt2}\sin\left(\frac{u}{\sqrt2}\right)\sin(v) \\[1em]
(1-r\cos(v))\sin\left(\frac{u}{\sqrt{2}}\right)-\frac{r}{\sqrt2}\cos\left(\frac{u}{\sqrt2}\right)\sin(v) \\[1em]
\displaystyle \frac{u+r\sin(v)}{\sqrt{2}}
\end{array}\right).
\end{align*}
