...
r_1\sqrt{1-\dot{r_1}^2}\sin(v) \\
r_1\sqrt{1-\dot{r_1}^2}\cos(v) \\
(\gamma_1)_3+r_1\dot{r}_1
\end{array}\right)
\gamma_1 - r_1\dot{r_1}\mathbf{T_1} + r_1\sqrt{1-\dot{r_1}^2}(\mathbf{N_1}\cos(v)+\mathbf{B_1}\sin(v)) ,
$$
