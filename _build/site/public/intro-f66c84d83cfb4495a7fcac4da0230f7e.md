...
:::{figure} figs/6dc-12dc-round-graph.png
...
For example, [](#figs:6dc-12dc-round) has 2dc worked into every dc of the first round, for a total of 12dc in round 2. The result appears flat, but as many a crocheter will have found, it is rare for a work to stay that way. Is there a reliable method to calculate the number of stitches required for a flat disc? Or indeed for any other specified curvature?