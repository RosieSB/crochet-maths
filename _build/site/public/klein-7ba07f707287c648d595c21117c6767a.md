...
for k in range(i,j+1):
    ...
    si_data[k-i] = np.array([row, st_count, increase ,st_omit, u1])
    
si_table = tabulate(si_data, headers=['Row','Stitch count + missing stitches','Increase','Stitches to omit from previous row', 'u'],tablefmt='html')
display(si_table)
