...
::::{grid-item}
$$
\theta=2\arcsin\left(\frac{w}{2(R-r)}\right) %w=2(R-r)\sin\left(\frac{\theta}{2}\right) 
$$
::::
:::::
where $w$ denotes stitch width, and $R$, $r$ is the major and minor radii of each torus. 
...
Turning angle: $\theta = \frac{w}{R-r} =${eval}`theta= 
