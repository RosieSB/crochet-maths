...
or, more lengthily,
$$
\mathbf{x}(u,v) = \gamma(u)-\frac{r(u)|\dot r(u)|}{\Vert\dot\gamma(u)\Vert^2}\dot\gamma(u) + r(u)\left(1-\frac{\dot r(u)^2}{\Vert\dot\gamma(u)\Vert^2}\right)^{\frac{1}{2}}\left( \mathbf{N}\cos(v)+\mathbf{B}\sin(v) \right)
$$

:::{note}
In pipe surface case, where $\dot r=0$, the parametrisation has simpler form
...
How would one prove this? Well, a torus is itself a pipe surface of a circle with radius $R$. 