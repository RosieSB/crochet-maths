...
Ideally, tension is uniform and all stitches are the same size. We can discuss the limitations of this assumption later. For now, let us label some lengths and angles for the flat case. Suppose every stitch has width 
