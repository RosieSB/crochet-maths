...
Attempt 2 (right) less distorted than attempt 1 (left), with more circular cross-sections.
:::

### Attempt 3

Now happy with width and height choices w={eval}`w`, h={eval}`h`; however, result is very small. Next pattern will have the same w and h, but larger R and r.
