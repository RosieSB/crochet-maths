...
$$
r = \frac{1}{u^2}, \;\; 2\leq u\leq 7
$$ 

Then $\dot r= \frac{-2}{u^3}$, so $|\dot r|=\frac{2}{u^3}<1=|\dot\gamma|$, provided $u>2^{1/3}=1.2599...$. We get
...
\frac{1}{\sqrt{2}}
\end{array}\right) \\
&\hspace{1.5em}+ \frac{\sqrt{u^6-4}}{u^5}\left(\begin{array}{c} 
...
\end{array}\right) \\
&= \left(\begin{array}{c} 
\cos\left(\frac{u}{\sqrt{2}}\right)  -\frac{\sqrt2}{u^5}\sin\left(\frac{u}{\sqrt{2}}\right) -\frac{\sqrt{u^6-4}}{u^5}\cos\left(\frac{u}{\sqrt{2}}\right)\cos(v)+\frac{1}{\sqrt{2}}\sin\left(\frac{u}{\sqrt{2}}\right)\sin(v)\\
\sin\left(\frac{u}{\sqrt{2}}\right) + \frac{\sqrt2}{u^5}\cos\left(\frac{u}{\sqrt{2}}\right) -\frac{\sqrt{u^6-4}}{u^5}\sin\left(\frac{u}{\sqrt{2}}\right)\cos(v)-\frac{1}{\sqrt{2}}\cos\left(\frac{u}{\sqrt{2}}\right)\sin(v) \\
\frac{u}{\sqrt{2}} + \frac{\sqrt2}{u^5} + \frac{\sqrt{u^6-4}}{u^5}\frac{1}{\sqrt{2}}\sin(v)
\end{array}\right)\\
&\hspace{1.5em}+ \left(\begin{array}{c} 
 \\
 \\
\end{array}\right)
\end{align*}
