...
- Of pipe: principal curvatures of the pipe are $\kappa_v=\frac{1}{r}=${eval}`kappa_v` and 
$$
\kappa_u=\frac{1}{(R-r\cos(u))},
$$
which in this case varies between $-\frac{1}{R-r}=${eval}`kappa_u_min` inside the bend, and $\frac{1}{R+r}=${eval}`kappa_u_max` on the outermost point of the bend. 
...
- Of pipe: principal curvatures of the pipe are $\kappa_v=\frac{1}{r}=${eval}`kappa_v` and $\kappa_u=\frac{1}{(R-r\cos(u))}$, which in this case varies between $-\frac{1}{R-r}=${eval}`kappa_u_min` inside the bend, and $\frac{1}{R+r}=${eval}`kappa_u_max` on the outermost point of the bend. 
