...
$$
and constant Frenet-Serret apparatus $\mathbf{T}=(0,0,1)$, $\mathbf{N}=(0,1,0)$, $\mathbf{B}=(1,0,0)$ along $\gamma$. The radius function comes in three pieces:
$$
r(u)=\left\{\begin{array}{lr} \sqrt{e^2-(u-d)^2} & \text{ for } d\leq u\leq d+e\sin\phi \\
d\tan\phi+e\sec\phi-u\tan\phi & \text{ for } d+e\sin\phi\leq u\leq d+h-c\sin\phi \\
...
$$
\dot{r}(u)=\left\{\begin{array}{lr} -\frac{u-d}{\sqrt{e^2-(u-d)^2}} & \text{ for } d\leq u\leq d+e\sin\phi \\
-\tan\phi & \text{ for } d+e\sin\phi\leq u\leq d+h-c\sin\phi \\
...
and
$$
\ddot{r}(u)=\left\{\begin{array}{lr} -e^2\left(e^2-(u-d)^2\right)^{\frac{3}{2}} & \text{ for } d\leq u\leq d+e\sin\phi \\
0 & \text{ for } d+e\sin\phi\leq u\leq d+h-c\sin\phi \\
\frac{\sqrt{c^2-(u-d-h)^2}-\frac{(u-d-h)^2}{\sqrt{c^2-(u-d-h)^2}}}{c^2-(u-d-h)^2} & \text{ for } d+h-c\sin\phi\leq u\leq d+h,
\end{array}\right.
$$
Moreover, 
:::{math}
