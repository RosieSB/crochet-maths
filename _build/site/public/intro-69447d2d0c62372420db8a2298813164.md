...
A UK double crochet (or US single crochet) ostensibly has 2 parts: a v part, which is always visible, and a top loop, which sometimes is partially or entirely covered by subsequent stitches. Technically, the loop part here is more closely attached to the stitch over to the right, but for the purposes of pattern organisation (especially in colour work) it is useful to group stitches this way.
