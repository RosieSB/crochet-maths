...
We can also calculate the $u$ steps required (this will not be constant). Write $0=u_0,u_1,u_2,\ldots$ for the $u$ values associated with rows $n=0,1,2\ldots$. Then,
$$
