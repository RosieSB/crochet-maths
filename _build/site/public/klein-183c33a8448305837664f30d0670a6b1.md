...
u = np.concatenate([usplit[4],usplit[5]])
r=np.concatenate([r4,r5])
rdot=np.concatenate([r4dot,r5dot])
rddot=np.concatenate([r4ddot,r5ddot])
gamma = np.concatenate([gamma4[2],gamma5[2]])
z = gamma-r*rdot
