...
The coupled equations [](eq:gd) can be solved numerically as an initial value problem, by specifying an initial point and a value for the parameter $c$. Below is an interactive implementation of this using ipywidgets. 
