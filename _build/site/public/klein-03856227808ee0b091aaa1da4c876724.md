...
r_1(u_1)\sqrt{1-\tan^2\phi}\sin(v_1) &=& p\sin(v_2) &(A)\\
r_1(u_1)\sqrt{1-\tan^2\phi}\cos(v_1) &=& (\gamma_2(u_2))_2+p\hat{\overrightarrow{PQ}}_3 &(B)\\
(\gamma_1(u_1))_3+r_1\tan\phi &=& (\gamma_2(u_2))_3-p\hat{\overrightarrow{PQ}}_2 &(C)
\end{array}\right.
$$
