...
:::
For the $z$-intercept, using the coordinates of $Q$,
$$
...
\begin{gather*}
\gamma_1(u) = \left(0, b+b\cos\left(np.pi-\frac{u}{b}\right), d+b\sin\left(np.pi-\frac{u}{b}\right)\right), \hspace{1em} 0\leq u\leq b\theta \\
...
\gamma_3(u) = \left( 0, a\left(1+\cos\left(\frac{u}{a}-\theta\right)\right), H+a\sin\left(\frac{u}{a}-\theta\right)\right), \hspace{1em} 0\leq u\leq a*(np.pi+theta) \\
\gamma_4(u) = (0*u,0*u,H-u) \hspace{1em} 0\leq u\leq H-d
\end{gather*}
