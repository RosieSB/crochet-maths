...
$$
\mathbf{x} = \left(\begin{array}{c}
\left(p+c-\sqrt{c^2-(u-d-h)^2}\right)\sqrt{\frac{x^2-2(u-d-h)^2}{x^2-(u-d-h)^2}}\sin(v)\\[1em]
\left(p+c-\sqrt{c^2-(u-d-h)^2}\right)\sqrt{\frac{x^2-2(u-d-h)^2}{x^2-(u-d-h)^2}}\cos(v)\\[1em]
