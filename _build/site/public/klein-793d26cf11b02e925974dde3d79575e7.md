...
r_1(u_1)\sqrt{1-\tan^2\phi}\cos(v_1) &=& (\gamma_2(u_2))_2+p\hat{\overrightarrow{PQ}}_3\cos(v_2) \\
(\gamma_1(u_1))_3+r_1\tan\phi &=& (\gamma_2(u_2))_3-p\hat{\overrightarrow{PQ}}_2\cos(v_2)
\end{array}\right.
$$
...
$$
\left\{\begin{array}{rclr}
r_1(u_1)\sqrt{1-\tan^2\phi} &=& (\gamma_2(u_2))_2+p\hat{\overrightarrow{PQ}}_3 &\text{ (A)}\\
(\gamma_1(u_1))_3+r_1\tan\phi &=& (\gamma_2(u_2))_3-p\hat{\overrightarrow{PQ}}_2 &\text{ (B)}
\end{array}\right.
$$
