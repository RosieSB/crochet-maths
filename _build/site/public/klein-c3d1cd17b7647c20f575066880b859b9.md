...
(0, b+b\cos\left(\pi-\frac{u-t_1}{b}\right), d+b\sin\left(\pi-\frac{u-d}{b}\right)) & t_1\leq u\leq t_2 \\
\frac{u-t[2]}{\Vert\overrightarrow{PQ}\Vert}P + \left(1-\frac{u-t[2]}{\Vert\overrightarrow{PQ}\Vert}\right)Q & t_2\leq u\leq t_3 \\
( 0*u, a*(1+np.cos( (u-t[3])/a-theta )), H+a*np.sin( (u-t[3])/a-theta ) ) & t_3\leq u\leq t_4 \\
(0*u,0*u,H-u+t[4])& t_4\leq u\leq t_5 \\
(0*u,0*u,H-c*np.sin(phi)-u+t[5]) & t_5\leq u\leq t_6 \\
(0*u,0*u,d*np.sin(u))& t_6\leq u\leq t_7 \\
(0*u,0*u,e*np.sin(phi)-u+t[6]+d)& t_7\leq u\leq t_8 \\
\end{array}\right.
$$
