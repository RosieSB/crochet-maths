...
**Set up:** Chain $\text{round}\left(\frac{2\pi(R-r)}{w}\right)$ stitches and join into a round.

**Row n:** Crochet $\text{round}\left( \frac{2\pi}{w}\left(R-r\cos\left(\frac{n\pi}{N}\right)\right)\right)$ stitches around. Taking care to spread increases as evenly as possible.
