...
$$
\begin{aligned}
\mathbf{x}_u  &= \left(1-r\ddot{r}-\dot{r}^2\right)\mathbf{T} + \frac{\dot{r}\left(1-\dot{r}^2-r\ddot{r}\right)}{\sqrt{1-\dot{r}^2}}\cos(v)\mathbf{N} + \left(\dot{r}\sqrt{1-{\dot r}^2}-\frac{\dot{r}r}{\sqrt{1-\dot{r}^2}}\right)\sin(v)\mathbf{B},
\\[1em]
