...
What about subsequent rounds? Crochet is now indistinguishable locally from crocheting in rows, and we can use our previous work [](#eq:K(v)-crochet) to calculate the curvature of the subsequent rounds of stitches.

**Round 2:** For $j=0,\ldots,5$, $d(v_{0j})=5$, and so
$$ 
K(v_{0j}) = 
$$