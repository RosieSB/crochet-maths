...
**Rows {eval}`max(row0)+2*int(np.round(theta/turning_angle_b))+int(np.round(magPQ/h))+3`–{eval}`max(row0)+2*int(np.round(theta/turning_angle_b))+int(np.round(magPQ/h))+2*int(np.round((np.pi+theta)/turning_angle_a))+3`** 
