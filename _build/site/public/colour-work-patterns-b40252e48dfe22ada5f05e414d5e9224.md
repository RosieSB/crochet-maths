...
I would like to make one more pattern, with the correct stitch dimensions w={eval}`w`, h={eval}`h`, and larger choices for R and r. Specifically, I would like one twice as big. 
