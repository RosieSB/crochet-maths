...
(0, b+b\cos\left(\pi-\frac{u-d}{b}\right), d+b\sin\left(\pi-\frac{u-d}{b}\right)) & 0\leq u\leq d \\
\frac{u-t[2]}{\Vert\overrightarrow{PQ}\Vert}P + \left(1-\frac{u-t[2]}{\Vert\overrightarrow{PQ}\Vert}\right)Q & d\leq u\leq \\
\end{array}\right.
$$
