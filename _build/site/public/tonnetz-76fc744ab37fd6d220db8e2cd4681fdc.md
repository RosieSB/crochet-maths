...
For reasons I currently can't be bothered to go into, I would like to crochet a torus with the standard tonnetz on it. This requires a triangulation of a torus as in 

:::{embed} #fig:tonnetz-grid
:::

Below is some code that will do this, along with its output pattern. Parameters chosen are $R=5$, $r=3$, $w=0.4$, $h=0.4$ (c.f.~[](#CT)).
