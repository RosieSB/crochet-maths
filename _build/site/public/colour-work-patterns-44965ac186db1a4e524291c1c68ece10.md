...
for n in range(N+1):
    for k in range(st_count[n]):
        # upper
        ax.scatter(k*st_count[N]/(st_count[n]-1)-st_count[N]/2, n, color=colours_upper[n][k])
        #lower
        if 0<n<N:
            ax.scatter(k*st_count[N]/(st_count[n]-1)-st_count[N]/2, -n, color=colours_lower[n][k])
